...
def get_config():
    ...
    parser.add_argument("--env_name", type=str, default='ATTN', help="specify the name of environment")
    ...
    parser.add_argument("--hypernet_embed", type=int, default=32)
    parser.add_argument("--consensus_builder_hidden_dim", type=int,
                        default=64)
    parser.add_argument("--center_tau", type=float, default=0.9)
    parser.add_argument("--online_temp", type=float, default=0.1)
    parser.add_argument("--target_temp", type=float, default=0.04)
    parser.add_argument("--grad_norm_clip", type=float, default=10)
    parser.add_argument("--obs_agent_id", type=bool, default=True)
    parser.add_argument("--obs_last_action", type=bool, default=True)

    parser.add_argument("--use_attn", action='store_true',
                        default=True, help='Whether agent use attn policy')
    parser.add_argument("--att_hidden", type=int, default=256,
                        help="Dimension of hidden layers for attn networks")
    parser.add_argument("--est_gama", type=float, default=2,
                        help="Gamma of est weight in loss")
    parser.add_argument("--comm_dis", type=float, default=2.5,
                        help="distance of communication")
    ...
    parser.add_argument("--gamma", type=float, default=0.8,
                        help='discount factor for rewards (default: 0.8)')
    ...
    parser.add_argument("--eval_buffer", action='store_true', default=False, help="knowledge distillation.")
    parser.add_argument("--eval_cons", action='store_true', default=False, help="knowledge distillation.")
